...
while st.session_state.button_pressed:
    res = pd.DataFrame(columns=['ETF', 'Amount', 'Qty'])
    current_time = time.time()
    if current_time - st.session_state.last_analysis_time >= 30:  # 5 minutes in seconds
